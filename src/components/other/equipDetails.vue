			...
			>
				...
				<main class="px-7.5 lt-laptop-(px-5)">
					<div class="flex-center mb-1">
						...
						/>
						<div
							class="flex-w-rest ml-4 text-4.5 lt-laptop-(ml-2.5 text-4)"
						>
					...
					>
						<div class="fill-parent relative">
							...
							>
								...
								>
									<div
										class="flex-between mb-3 lt-laptop-(mb-2)"
									>
									...
									<div class="flex-center gap-2">
										...
										/>
										<div
											class="flex-w-rest overflow-hidden"
										>
											<div
