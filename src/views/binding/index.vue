<template>
  ...
  <div class="relative w-full h-full" v-else>
    ...
    <div class="binding_container rounded-lg w-full">
      ...
      <NForm class="mt-90px" ref="formRef" :model="formData" :rules="rules">
        ...
        <NFormItem class="h-80px mb-2 -translate-y-10px" path="phonenumber">
          <div class="w-full">
            <NInput
            ...
            >
              >
              <template #prefix>
                <div class="i-icons:phone text-#8A92A6 w-4 h-4 mr-2"></div>
                <div class="right_line"></div>
              </template>
            </NInput>
          </div>
        ...
        <NButton
          ...
          style="
            ...
            border-radius: 8px;
            border: none;
            background: linear-gradient(292deg, #1b78fc 22%, #48b3ff 93%);
          "
          :bordered="false"
