    ...
    <div class="overflow-scroll flex-1">
      <NForm ref="formRef" :model="formData" :rules="rules">
        <div class="flex gap-14 mb-4 w-full">
          ...
          <div class="flex-1 flex-col max-w-600px">
            ...
            <div class="item-container flex items-center h-64px w-full">
              ...
              <NFormItem class="flex-1" path="constructionStandards">
                <NInput
                  v-model:value="formData.constructionStandards"
                  placeholder="请输入"
                  class="!text-14px"
                >
                </NInput>
            ...
            <div class="item-container flex items-center h-64px w-full">
              ...
              <NFormItem class="flex-1" path="estimatedInvestment">
                <NInputNumber
            ...
            <div class="item-container flex items-center h-64px w-full">
              ...
              <NFormItem class="flex-1" path="landApprovalDate">
                <NDatePicker
                  v-model:formatted-value="formData.landApprovalDate"
          ...
          <div class="flex-1 max-w-600px">
            ...
            <!--  -->
            <div class="item-container flex items-center h-64px w-full">
              <div class="w-28 mr-4 text-align-end">路线性质:</div>
        ...
        >
          ...
          <NFormItem class="flex-1 h-50px" path="constructionTechStandards">
            <NInput
        ...
        >
          ...
          <NFormItem class="flex-1 h-50px" path="projectSignificanceBenefits">
            <NInput
...
const rules = {
  ...
  startPoint: [{ required: true, message: "请输入项目起点", trigger: "blur" }],
